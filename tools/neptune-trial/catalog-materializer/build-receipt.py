...
def main():
    ...
    files = ["materialize.py", "inventory_census.py", "coverage_report.py", "worker.py", "supervisor.py", "Dockerfile", ".dockerignore", "requirements.lock", "test_materialize.py", "test_inventory_census.py", "test_inventory_integration.py", "test_coverage_report.py", "test_supervisor.py", "image-inputs.json", "repair_plan.py", "repair_runtime.py", "repair_supervisor.py", "test_repair_plan.py", "test_repair_runtime.py"]
